    ...
    return (
      <div className="flex-1 bg-linear-to-b from-[#1a1a1a] to-[#121212] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[#a6a6a6] text-sm">Loading artist...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 bg-linear-to-b from-[#1a1a1a] to-[#121212] overflow-y-auto scrollbar-thin scrollbar-thumb-[#333] scrollbar-track-transparent">
      ...
      <div className="px-8 pb-8 pt-8 flex items-end gap-7">
        <div className="w-[232px] h-[232px] shrink-0 rounded-full overflow-hidden shadow-2xl bg-[#282828] flex items-center justify-center">
          {picture ? (
            <img
            ...
            <User size={72} className="text-[#8a8a8a]" />
          )}
        </div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 px-6 pt-5 pb-4">
              <div className="w-11 h-11 shrink-0 rounded-full overflow-hidden bg-[#282828]">
                {picture ? (
                  <img
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[13px] text-[#a6a6a6]">Biography</p>
              </div>
              <button
                onClick={() => setShowBioModal(false)}
            ...
            {/* Bio text */}
            <div className="px-6 pb-6 overflow-y-auto scrollbar-thin scrollbar-thumb-[#333] scrollbar-track-transparent">
              {cleanBio(bio)
                .split(/\n\n|\n/)
                .filter((p) => p.trim())
                .map((paragraph, i) => (
              ...
              <p className="text-[12px] text-[#666] mt-6 italic">
                  ...
                  <div className="flex items-center justify-end">
                    {playing ? (
                      <div className="flex items-end gap-[3px] h-4">
                        ...
                        <span
                          className="w-[3px] h-full bg-[#00FFFF] rounded-full playing-bar"
      ...
      {topTracks.length === 0 && albums.length === 0 && (
        <div className="px-8 py-16 text-center">
          <User size={48} className="text-[#535353] mx-auto mb-4" />
